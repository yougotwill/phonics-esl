...
const Modal = ({ handleToggleModal, phonic }) => {
  ...
  return (
    <div className='fixed w-full h-full inset-0 z-50 overflow-hidden modal' onClick={handleToggleModal}>
      <div className='shadow-lg w-screen sm:w-2/3 sm:my-8 sm:mx-auto rounded z-50 overflow-y-auto absolute inset-0 modal-container' onClick={(event) => { handleModal(event); }}>
